...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        CreateTotalSpentSection(month, expenses, page);
    ...
    private void CreateTotalSpentSection(DateOnly month, List<Expense> expenses, Section page)
    {
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var pathfile = Path.Combine(directoryName!, "UseCases\\Expenses\\Reports\\Pdf\\Logo", "a.png");


        row.Cells[0].AddImage(pathfile);
        row.Cells[1].AddParagraph($"Hey, Jorge");
